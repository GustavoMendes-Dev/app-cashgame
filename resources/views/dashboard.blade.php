						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div class="row g-5 g-xl-8">
									<div class="col-xl-3">
										...
										<a href="{{ route('matchs.index') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
											<!--begin::Body-->
											<div class="card-body">
												...
												<!--end::Svg Icon-->
												<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{ $matchs }}</div>
												<div class="fw-bold text-gray-400">Partidas criadas</div>
											</div>
											<!--end::Body-->
										</a>
									...
									<div class="col-xl-3">
										<!--begin::Statistics Widget 5-->
										<a href="{{ route('players.index') }}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
											<!--begin::Body-->
											<div class="card-body">
												...
												<!--end::Svg Icon-->
												<div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{ $players }}</div>
												<div class="fw-bold text-gray-100">Jogadores cadastrados</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Statistics Widget 5-->
									...
									<div class="col-xl-3">
										<!--begin::Statistics Widget 5-->
										<a href="{{ route('matchs.index') }}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
											<!--begin::Body-->
											<div class="card-body">
									...
									<div class="col-xl-3">
										<!--begin::Statistics Widget 5-->
										<a href="{{ route('movements.index') }}" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
											<!--begin::Body-->
											<div class="card-body">
												...
												<!--end::Svg Icon-->
												<div class="text-white fw-bolder fs-2 mb-2 mt-5">R$ {{ number_format($total, 2, ',' , '.') }}</div>
												<div class="fw-bold text-white">Balanço do dia</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Statistics Widget 5-->
