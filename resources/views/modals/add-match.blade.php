		...
		<div class="modal fade" id="modal_add_match" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
						<!--begin::Form-->
						<form id="kt_modal_new_match" class="form" action="/matchs" method="POST">
							...
							<div class="d-flex flex-column mb-7 fv-row">
								...
								<!--end::Label-->
								<input type="text" class="form-control form-control-solid" placeholder="" name="title_match" required/>
							</div>
							<!--end::Input group-->
							<!--begin::Actions-->
