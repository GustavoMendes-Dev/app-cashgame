                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-bold fs-7">{{ count($players) }} @yield('title')</span>
                        </h3>
                        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="" data-bs-original-title="Click to add a user">
                            <button onclick="AddPlayer()" href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                ...
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-120px">Apelido</th>
                                ...
                                <tbody>
                                    @foreach ($players as $player)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ url('/players', $player->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                <form class="form-delete" action="{{ url('/players', $player->id)}}" method="POST">
...
@include('modals.add-player')
<script>
    let modal = document.querySelector("#modal_add_player");
